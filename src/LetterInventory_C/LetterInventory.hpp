 ...
 #define SAMPLE_STRING "According to all known laws of aviation, there is no way a bee should be able to fly.\
 ...
 I know how hard it is to find the right job. We have that in common.checkValid\
 Do we?\
